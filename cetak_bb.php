...
$nama_dokumen = 'Laporan Buku Besar'; //Beri nama file PDF hasil.
...
<body>
    ...
    <table border="1" width="100%" class="table1">
        ...
        while ($rows = mysqli_fetch_array($query)) {
            ...
            <tr>
                <th colspan="4" align="left"><b>Nama Akun : <?= $rows['nama_akun'] ?></b></th>
                <th colspan="2">
            ...
            <tr>
                <td rowspan="2" class="center" width="15%"><b>Tanggal</b></td>
                <td rowspan="2" class="center" width="20%"><b>Keterangan</b></td>
                <td rowspan="2" class="center" width="17%"><b>Debit</b></td>
                <td rowspan="2" class="center" width="16%"><b>Kredit</b></td>
                <td colspan="2" class="center" align="center"><b>Saldo</b></td>
            </tr>
            <tr>
                <td class="center" width="17%"><b>Debit</b></td>
