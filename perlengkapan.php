...
$sql = "SELECT max(kode_perlengkapan) FROM perlengkapan";
$query = mysqli_query($connect, $sql);

$kode_perlengkapan = mysqli_fetch_array($query);

if ($kode_perlengkapan) {
    $nilai = substr($kode_perlengkapan[0], 1);
    $kode = (int)$nilai;
...
<div class="main-content">
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Add Perlengkapan dan Peralatan</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="index.html">Data</a></li>
                        <li><span>Perlengkapan dan Peralatan</span></li>
                    </ul>
                </div>
                <?php include "jam.php"; ?>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <h4 class="header-title">Perlengkapan</h4>
                                        ...
                                        <table id="dataTable3" class="text-justify table table-hover table-sm " width="100%">
                                            <thead class="text-capitalize">
                                                <tr>
                                                    ...
                                                    <th width="18%">Kode Perlengkapan</th>
                                                    <th width="35%">Keterangan</th>
                                                    <th width="22%">Nominal Total</th>
                                            ...
                                            include "connection/connection.php";
                                            // jalankan query
                                            $result = mysqli_query($connect, "SELECT * FROM perlengkapan  
                                    INNER JOIN akun ON perlengkapan.id_akun=akun.id_akun");
                                            ...
                                            while ($row = mysqli_fetch_object($result)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?= $row->tanggal ?></td>
                                                        <td><?= $row->kode_perlengkapan ?></td>
                                                        <td><?= $row->keterangan ?></td>
                                                        <td><?= $row->total ?></td>
                                                        <td>
                                                            <button type="submit" data-id="<?php echo $row->id_perlengkapan; ?>" class="btn btn-danger btn-flat btn-sm mt-3 open-AddBookDialog" data-toggle="modal" data-target="#exampleModalLong"><i class="ti-trash"></i> </button>
                                    ...
                                    <div class="col-lg-6 col-ml-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    <form role="form" action="simpan_perlengkapan.php" method="post">
                                                        <div class="card-body">
                                                            <h4 class="header-title">Input data Perlengkapan </h4>
                                                            <p class="text-muted font-14 mb-4">Isikan data Perlengkapan anda</p>
                                                            <div class="form-group">
                                                                <label for="example-text-input" class="col-form-label">Kode Perlengkapan</label>
                                                                <input class="form-control" type="text" value="<?php echo $auto_kode; ?>" readonly id="kode_perlengkapan" name="kode_perlengkapan">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" required value="" id="keterangan " name="keterangan_perlengkapan">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="example-number-input" class="col-form-label">Harga Perlengkapan </label>
            ...
            <!-- Modal -->
            <form action="hapus_perlengkapan.php" method="post">
