...
$sql = "SELECT max(kode_prive) FROM modal";
$query = mysqli_query($connect, $sql);

$kode_prive = mysqli_fetch_array($query);

if ($kode_prive) {
    $nilai = substr($kode_prive[0], 1);
    $kode = (int)$nilai;

    //tambahkan sebanyak + 1
    $kode = $kode + 1;
    $auto_kode = "PR" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
} else {
    $auto_kode = "PR0001";
}
?>
...
<div class="main-content">
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Add Prive</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="index.html">Data</a></li>
                        <li><span>Prive</span></li>
                    </ul>
                </div>
                <?php include "jam.php"; ?>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <h4 class="header-title">Prive</h4>
                                    <div class="data-tables datatable-dark">
                                        <table id="dataTable3" class="text-justify table table-hover table-sm " width="100%">
                                            ...
                                            include "connection/connection.php";
                                            // jalankan query
                                            $result = mysqli_query($connect, "SELECT * FROM prive  
                                    INNER JOIN akun ON prive.id_akun=akun.id_akun");
                                            ...
                                            while ($row = mysqli_fetch_object($result)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?= $row->tanggal ?></td>
                                                        <td><?= $row->kode_prive ?></td>
                                                        <td><?= $row->keterangan ?></td>
                                                        <td><?= $row->nominal ?></td>
                                                        <td>
                                                            <button type="submit" data-id="<?php echo $row->id_prive; ?>" class="btn btn-danger btn-flat btn-sm mt-3 open-AddBookDialog" data-toggle="modal" data-target="#exampleModalLong"><i class="ti-trash"></i> </button>
                                    ...
                                    <div class="col-lg-6 col-ml-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    <form role="form" action="simpan_prive.php" method="post">
                                                        <div class="card-body">
                                                            <h4 class="header-title">Input data Prive </h4>
                                                            <p class="text-muted font-14 mb-4">Isikan data Prive anda</p>
                                                            <div class="form-group">
                                                                <label for="example-text-input" class="col-form-label">Kode Prive</label>
                                                                <input class="form-control" type="text" value="<?php echo $auto_kode; ?>" readonly id="kode_prive" name="kode_prive">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" required value="" id="keterangan " name="keterangan_prive">
                                                            </div>
                                                            <div class="form-group">
            ...
            <!-- Modal -->
            <form action="hapus_prive.php" method="post">
